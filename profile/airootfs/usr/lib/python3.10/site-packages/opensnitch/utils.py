    ...
    def load(self):
        ...
        try:
            ...
            if os.path.isfile(IPASN_DB_PATH) == False:
                IPASN_DB_PATH = '/usr/lib/python3.10/site-packages/pyasn/data/ipasn_20140513_v12.dat.gz'
            if os.path.isfile(AS_NAMES_FILE_PATH) == False:
                AS_NAMES_FILE_PATH = '/usr/lib/python3.10/site-packages/pyasn/data/asnames.json'
